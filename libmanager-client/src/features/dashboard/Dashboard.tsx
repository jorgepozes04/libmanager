  ...
  return (
    <Page title="Painel de Controle">
      <div className="dashboard-grid">
        ...
        <div
          className="dashboard-card"
          onClick={() => onNavigate("cadastroCliente")}
        >
        ...
        <div
          className="dashboard-card"
          onClick={() => onNavigate("cadastroLivro")}
        >
        ...
        <div
          className="dashboard-card"
          onClick={() => onNavigate("cadastroRevista")}
        >
        ...
        {userCargo === "ADMIN" && (
          <div
            className="dashboard-card"
            onClick={() => onNavigate("gerenciarUsuarios")}
          >
